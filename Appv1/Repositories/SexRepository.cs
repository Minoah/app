...
namespace Appv1.Repositories
{
    ...
    public class SexRepository : ISexRepository
    {
        ...
        {
            IQueryable<SexDAO> Sexs = DataContext.Sexes;
        ...
        public async Task<List<Sex>> List(SexFilter filter)
        {
            ...
            IQueryable<SexDAO> SexDAOs = DataContext.Sexes;
        ...
        {
            Sex Sex = await DataContext.Sexes.Where(x => x.Id == Id).Select(x => new Sex()
            {
                Id = x.Id,
                Code = x.Code,
                Name = x.Name,
            ...
            if (Sex == null)
                return null;
            Sex.Admins = await DataContext.Admins
